    ...
    def generateReports():        
        if request.method == 'POST':
            ...
            if catagory == "mfactured":
                ...
                select_q = "SELECT tp.SerialNo, tp.OS, tp.Manufacturer, tp.PurchasedDate, d.AssetNo, d.device_name, d.device_condition, d.device_type, tp.Description FROM ThirdpartyDevice as tp, Device as d "
